...
function scrollHeader(){
    ...
    if(this.scrollY >= 200) nav.classList.add('scrollHeader')
...
const getCurrentIcon = () => themeButton.body.classList.contains(iconTheme) ? 'bx-toggle-left' : 'light'

// We Validate if the user previously chose a topic (menyimpan dark theme jika keluar web tetap dark theme)
if (selectedTheme) {
